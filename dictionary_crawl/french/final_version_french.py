...
# Main program
input_filename = 'd:\\CS370\\dictionary_crawl\\french\\french_dict1.json'  # The file from which to read the JSON data
output_filename = 'd:\\CS370\\dictionary_crawl\\french\\modified_data.json'  # The file to save the modified JSON data
